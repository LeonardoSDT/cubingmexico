...
urlpatterns = [
    ...
    path('competitor_tutorial/', CompetitorTutorialView.as_view(), name='competitor_tutorial'),
    ...
    path('sponsors_cup/', SponsorsCupView.as_view(), name='sponsors_cup'),
    ...
    path('rankings/<str:gender>/<str:event_type>/<str:ranking_type>/', RankingsView.as_view(), name='rankings'),
    path('rankings/<str:gender>/<str:event_type>/<str:ranking_type>/<str:state>/', RankingsView.as_view(), name='rankings'),
    path('records/<str:gender>/', RecordsView.as_view(), name='records'),
    path('records/<str:gender>/<str:state>/', RecordsView.as_view(), name='records'),
